...
dir_edited_dataset = Path(r'D:\datensatz neu\edited_dataset_test')
...
for subdir, dirs, files in os.walk(dir_dataset):
    for file in files:
        ...
        # Anzeige des bearbeiteten Bildes
        #plt.imshow(resized_image, cmap='gray')  # Verwende Graustufen-Karte für bessere Darstellung
        #plt.show()
